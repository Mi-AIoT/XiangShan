...
class PhysicalQueueToVirtualStoreQueueIO(PhysicalQueuePtr: MultiFlagCircularQueuePtr[_]) (implicit p: Parameters) extends XSBundle {
...
class VirtualStoreQueueIO(PhysicalQueuePtr: MultiFlagCircularQueuePtr[_])
                         (implicit p: Parameters) extends XSBundle {
